...
<body>
		...
		<section class="container site-section">
			<h1 class="text-center text-primary mt-5 mb-4"> Update Event</h1>
		</section>
		...
		<?php
					$event_id = $_POST['event_id'];
		  			...
		  			$event= $pdo->query($sql)->fetch();
		  			?>

		<form class="container site-section mt-4 mb-5" method="post" action="updateevent_db.php" enctype="multipart/form-data">
		<input type="hidden" name="event_id" value=<?php echo $event_id?>>
		

		  <div class="form-group">
		    <label for="event_name">Event Name</label>
		    <input type="text" class="form-control" id="event_name" placeholder="Event Name" name="name" value="<?php echo $event['name']?>" >
		  ...
		  <div class="form-group">
		    ...
		    <select class="form-control" id="event_type" name="type" value="<?php echo $event['type']?>" required>
		 ...
		 <div class="form-group date">
			...
			<input type="date" class="form-control" id="event_date" name="date" value="<?php echo $event['date']?>" required>
		  ...
		  <div class="form-group">
    		...
    		<textarea class="form-control" id="event_description" rows="4" name="description" required><?php echo $event['description']?></textarea>
		  ...
		  <div class="form-group custom-file">
			...
			<label class="custom-file-label" id="event_photo_help" for="event_photo"><?php echo $event['photo_link']?></label>
		  ...
		  <div class="form-group mt-5">
		    ...
		    <input type="text" class="form-control" id="event_blog_link" placeholder="Event Blog Link" name="blog_link" value="<?php echo $event['blog_link']?>">
